...
public class Injector {
    ...
    public static GetAboutUsContent getAboutUsContent(@NonNull Context context){
        return new GetAboutUsContent(new AboutUsDataRepository(new AboutUsDataSource(context)));
    }
