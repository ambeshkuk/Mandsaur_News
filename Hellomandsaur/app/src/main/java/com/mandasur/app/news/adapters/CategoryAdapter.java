...
public class CategoryAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        NewsListFragment newsListFragment=NewsListFragment.
                ...
                newInstance(category.getCategory_indicator()
                        ,category.getCategory_name()
                        ,category.getIsSubCategoryAvailable());
        newsListFragment
                .setMainCategory(category.getCategory_name());

        NewsListContract.NewsListPresenter
                newsListPresenter=
                new NewsListPresenter(Injector.getNewsListByCategory(context),Injector.getShareNewsDetailsUseCase(context),
